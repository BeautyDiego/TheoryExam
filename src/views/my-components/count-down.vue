<template>
  <div>
    <p v-if="msTime.show">
      ...
      <!--<span>{{msTime.hour}}</span><i style="font-style:normal;">{{hourTxt}}</i>-->
      <span>{{msTime.minutes}}</span><i style="font-style:normal;">{{minutesTxt}}</i>
      <span>{{msTime.seconds}}</span><i style="font-style:normal;">{{secondsTxt}}</i>
    </p>
